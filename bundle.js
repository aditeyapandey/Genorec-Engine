...
const createFrequencyTableForScores =
  require("./utils.js").createFrequencyTableForScores;
...
if (testVersion) {
  ...
  // input.push({
  //   task: "task1",
  //   data: require("../evalspec/task1.json"),
  //   tasks: ["explore"],
  // });
  // input.push({
  //   task: "task3",
  //   data: require("../evalspec/task3.json"),
  //   tasks: ["explore"],
  // });
  // input.push({
  //   task: "task4",
  //   data: require("../evalspec/task4.json"),
  //   tasks: ["explore"],
  // });
...
//    input.push({"task":"task9", "data":require("../evalspec/task9.json"),"tasks":["explore"]});
 //   input.push({"task":"task10", "data":require("../evalspec/task9.json"),"tasks":["explore"]});
  ...
  function getRecommendation(inputData, taskId) {
    ...
    const viewGroups = [];
    const tasksUpdated = dataspec.hasOwnProperty("tasks")
      ? dataspec["tasks"]
      : [];
    ...
    for (var i = 0; i < sequenceInputArrays.length; i++) {
      ...
      const attributeEncoding = encodeAttributeUpdated(
        currentSequence,
        tasksUpdated
      );
      ...
      //Stage 3: Layout
      const getLayout = getLayoutUpdated(
        trackAlignment,
        tasksUpdated,
        dataspec["connectionType"]
      );
    ...
    //Stage 4: Partition
    const partition = getPartitionUpdated(
      viewGroups,
      tasksUpdated,
      dataspec["connectionType"]
    );
    ...
    //Stage 5: Arrangement
    const arrangement = getArrangementUpdated(
      partition,
      { connectionType: dataspec["connectionType"] },
      tasksUpdated
    );
    ...
    var recommendationSpecNonDuplicatesUpdated = checkDuplicates(
...
},{"../evalspec/task13.json":1,"./inputspec.js":20,"./s1_en_updated.js":22,"./s2_al_updated.js":23,"./s3_ls_updated.js":24,"./s4_pt_updated.js":25,"./s5_ar_updated.js":26,"./utils.js":27}],20:[function(require,module,exports){
